...
#endif
#ifdef DEFAULT_MAX_MAP_CONCAT
_DINT1(DEFAULT_MAX_MAP_CONCAT)
#else
_DNDEF("DEFAULT_MAX_MAP_CONCAT")
#endif
#ifdef MIN_MAP_CONCAT_LIMIT
_DINT1(MIN_MAP_CONCAT_LIMIT)
#else
_DNDEF("MIN_MAP_CONCAT_LIMIT")
#endif
